            ...
            <View style={{ marginHorizontal: 30 }}>
              ...
              {establishment.photos ? (
                <Image
                  style={styles.photo}
                  source={{
                    uri: `https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${establishment.photos[0].photo_reference}&sensor=false&key=${process.env.EXPO_GOOGLE_API_KEY}`,
                  }}
                  alt="Store perfil"
                />
              ) : (
                <Image style={styles.photo} source={noPhoto} />
              )}
